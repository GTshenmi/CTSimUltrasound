...
def main(use_gpu):
    ...
    log_dir = f'/home/xuepeng/ultrasound/neural_networks/iddpm_raw/run_record/test_{args.model_path.split("/")[-1].replace(".pt","")}'
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=2,
        use_ddim=False,
        model_path="/home/xuepeng/ultrasound/neural_networks/iddpm_raw/run_record/openai-2023-03-03-17-23-23-938923/ema_0.9999_200000.pt",
    )
