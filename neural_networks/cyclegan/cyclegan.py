...
parser.add_argument("--dataset_name", type=str, default="rf2us10", help="name of the dataset")
...
parser.add_argument("--network", type=str, default="cyclegan", help="if split test")
...
def sample_images(batches_done):
    ...
    image_grid = torch.cat((fake_A, real_A, fake_B, real_B), 1)
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, batch in enumerate(dataloader):
        ...
        loss_id_B = criterion_identity(fake_B, real_B)
